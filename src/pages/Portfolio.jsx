  ...
  return (
    <>
      ...
      <div className={styles.cardsContainer} >
        ...
        <h2> Filmes <img 
        className={styles.imgContainer}src="https://media.giphy.com/media/g9vQ5N2fmuB245NRWk/giphy.gif" alt="filmes" /></h2>
        <p>
        ...
        <div className={styles.itensContainer}>
        <h2>To-Do List <img className={styles.imgContainer} src="https://media.giphy.com/media/Ed848hrDHv5MnVRIwE/giphy.gif" alt="todolist" target='blank' /></h2>
        <p> Uma listinha de tarefas bem charmosa utilizando Javascript</p>
        <a className={styles.links} href="https://to-do-listpaty.netlify.app/" target='blank' >Clique aqui!</a>
        </div>
        ...
        <a className={styles.links} href="https://mylinkspaty.netlify.app/" target='blank' >Clique aqui!</a>
